-- Canonical: remove every CHECK on radio_story_levels / radio_story_completions, then level 1-6.
-- Extends level range from 1-4 (migration 010) to 1-6 so Radio Zumo can offer C1/C2.
