/** Curated single-word board list (Codenames-style; no proper nouns). */
module.exports = [
  ...
  "BEAR", "BEAT", "BED", "BEIJING", "BELL", "BELT", "BERLIN", "BERRY", "BILL",
  ...
  "CLIFF", "CLOAK", "CLOUD", "CLUB", "CODE", "COLD", "COMIC", "COMPOUND",
  "CONCERT", "CONDUCTOR", "CONTRACT", "COOK", "COPPER", "COTTON", "CRANE",
  "CRASH", "CRICKET", "CROSS", "CROWN", "CYCLE", "CZECH", "DANCE", "DATE",
  "DAY", "DEATH", "DECK", "DEGREE", "DIAMOND", "DINOSAUR", "DISEASE", "DOCTOR",
  "DOG", "DRAFT", "DRAGON", "DRESS", "DRILL", "DROP", "DUCK", "DWARF", "EAGLE",
  ...
  "GRACE", "GRASS", "GREECE", "GREEN", "GROUND", "HAM", "HAND", "HAWK", "HEAD",
  "HEART", "HELICOPTER", "HIMALAYAS", "HOLE", "HOLLYWOOD", "HONEY", "HOOD",
  "HOOK", "HORN", "HORSE", "HORSESHOE", "HOSPITAL", "HOTEL", "ICE", "ICICLE",
  "INDIA", "INK", "IRON", "IVORY", "JACK", "JAM", "JET", "JUPITER", "KANGAROO",
  "KETCHUP", "KEY", "KID", "KING", "KIWI", "KNIFE", "KNIGHT", "LAB", "LAP",
  "LASER", "LAWYER", "LEAD", "LEMON", "LEPRECHAUN", "LIFE", "LIGHT", "LIMOUSINE",
  "LINE", "LINK", "LION", "LITTER", "MONSTER", "LOCK", "LOG", "LONDON",
  ...
  "NEEDLE", "NET", "NIGHT", "NINJA", "NOTE", "NOVEL", "NURSE",
  ...
  "SHOT", "SINK", "SKYSCRAPER", "SLUG", "SMUGGLER", "SNOW", "SNOWMAN", "SOCK",
  ...
  "WAVE", "WEB", "WELL", "WHALE", "WHEEL", "WIND", "WITCH", "WORM", "YARD",
];
